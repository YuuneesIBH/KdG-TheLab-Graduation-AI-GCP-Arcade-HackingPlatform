      ...
      <div style={{
                  ...
                  <div style={{ display: 'grid', gap: '14px', alignContent: 'start' }}>
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <div style={{
                          position: 'absolute', left: '10%', right: '10%', top: '10px',
                          height: '10px', background: '#1a1a1a', border: '2px solid #000'
                        }} />
                        <div style={{
                          position: 'absolute', left: '15%', right: '15%', bottom: '12px',
                          height: '20px',
                          background: 'linear-gradient(180deg, #0088ff, #0066cc)',
                    ...
                    <div style={{
                      ...
                      <div style={{
                        color: '#ffff00', fontSize: '14px', letterSpacing: '3px',
                        marginBottom: '8px', textShadow: '0 0 15px #ffff00, 2px 2px 0 #002244'
                      }}>
                        ╔═ CREDITS ═╗
                      </div>
                      <div style={{
                        fontSize: '60px', fontWeight: 'bold', color: '#ffffff',
                        textAlign: 'center',
                        textShadow: '0 0 25px #00ccff, 0 0 50px #0088ff, 5px 5px 0 #002244',
                        lineHeight: '1'
                      }}>
                    ...
                    <div style={{
                      ...
                      <div style={{
                        height: '30px', background: '#001122',
                        border: '2px solid #002244', position: 'relative', overflow: 'hidden'
                      }}>
                        {Array.from({ length: 10 }).map((_, i) => (
                          <div key={i} style={{
                            position: 'absolute',
                            left: `${i * 10}%`, top: 0, width: '9.5%', height: '100%',
                            background: i < progress / 10
                              ? (i % 2 === 0 ? '#00ff88' : '#00ccff') : '#002244',
                            border: '1px solid #000',
                            boxShadow: i < progress / 10
                              ? `0 0 10px ${i % 2 === 0 ? '#00ff88' : '#00ccff'}` : 'none',
                            transition: 'all 0.2s'
                          }} />
                        ))}
                      </div>
                      <div style={{
                        ...
                        marginTop: '8px', color: '#00ccff', fontSize: '14px',
                        letterSpacing: '2px', textShadow: '0 0 8px #00ccff'
                      }}>
                        <span>LOADING...</span>
                        <span style={{
        ...
        <style>{`
          ...
          @keyframes horizon-glow {
            0%, 100% { box-shadow: 0 0 30px #0088ff, 0 0 60px #0066ff, 0 0 90px rgba(0,136,255,0.3); }
            50% { box-shadow: 0 0 40px #00aaff, 0 0 80px #0088ff, 0 0 120px rgba(0,136,255,0.5); }
          }
        `}</style>
      </div>
