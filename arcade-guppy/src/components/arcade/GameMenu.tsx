...
const games: GameCard[] = [
  ...
  { id: 'emulator', title: 'EMULATOR', genre: 'SYSTEM', badge: 'SYSTEM', tagline: 'Boot retro ROMs in a neon sandbox.', image: '../assets/emulator.png', accent: '#00ffc6', executable: 'games/Emulator/main.py', difficulty: '★☆☆', players: '1P', year: '2026' },
