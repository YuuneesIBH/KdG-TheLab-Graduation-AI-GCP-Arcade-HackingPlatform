...
> This folder is used as the **host fallback backend** in Arcade Guppy.
> For plug-and-play ESP32 operation, prefer firmware commands (`WIFI_DEAUTH_START/STOP`) over this script.
